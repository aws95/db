  ...
  const model = new Model({
    ...
    level1: {
      ...
      level2: {
        ...
        level3: {
          title: req.body.level1.level2.level3.title,
          level4: [product],
        },
      },
    },
    ...
    case "4":
      try {
        ...
        await db.collection(req.body.title).updateOne(
          ...
          {
            $push: {
              "level1.0.level2.0.level3.0.level4":
                model.level1[0].level2[0].level3[0].level4[0],
            },
          }
        );
    ...
    case "3":
      try {
        ...
        await db.collection(req.body.title).updateOne(
          ...
          {
            $push: {
              "level1.0.level2.0.level3": model.level1[0].level2[0].level3[0],
            },
          }
        );
    ...
    default:
      try {
        ...
        await db.collection(req.body.title).updateOne(
          ...
          {
            $push: {
              "level1.0.level2": model.level1[0].level2[0],
            },
          }
        );
    ...
    case "3":
      try {
        ...
        let add = await db.collection(req.body.title).updateOne(
          {
            _id: mongoose.Types.ObjectId(req.params.collectionID),
            "level1.0.level2.0.level3.title": req.params.category,
          },
          {
            $push: {
              "level1.0.level2.0.level3.$.level4":
                model.level1[0].level2[0].level3[0].level4[0],
            },
          }
        );
    ...
    case "2":
      try {
        ...
        let add = await db.collection(req.body.title).updateOne(
          {
            _id: mongoose.Types.ObjectId(req.params.collectionID),
            "level1.0.level2.1.level3.title": req.params.category,
          },
          {
            $push: {
              "level1.0.level2.1.level3.$.level4":
                model.level1[0].level2[0].level3[0].level4[0],
            },
          }
        );
      ...
      try {
        ...
        let add = await db.collection(req.body.title).updateOne(
          {
            _id: mongoose.Types.ObjectId(req.params.collectionID),
            "level1.0.level2.2.level3.title": req.params.category,
          },
          {
            $push: {
              "level1.0.level2.2.level3.$.level4":
                model.level1[0].level2[0].level3[0].level4[0],
            },
          }
        );
